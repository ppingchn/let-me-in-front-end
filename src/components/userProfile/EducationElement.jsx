    ...
    <div className="flex w-11/12 gap-3 py-4 border-b-[1px] border-gray mx-5 p-2">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col">
          <span className="font-bold">Chulalongkorn University</span>
          <div className="flex flex-col">
            {/* degree */}
            <span className="text-sm">Bachelor's degree, Art Education</span>
            {/* time length */}
            <span className="text-sm">2008-2013</span>
          </div>
          {/* grade */}
